...
(def create-edit_session-schema [{
                                  :raw [{:edit_sessions {}}],
...
(def create-static_pages-schema [{
                                  :raw [{:static_pages {}}],
...
(def create-delegations_users-schema [{
                                       :raw [
                                             {:delegations_users {}}
